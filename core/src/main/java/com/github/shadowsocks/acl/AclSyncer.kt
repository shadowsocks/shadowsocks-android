...
class AclSyncer(context: Context, workerParams: WorkerParameters) : CoroutineWorker(context, workerParams) {
    ...
    override suspend fun doWork(): Result = try {
        ...
        val connection = URL("https://raw.githubusercontent.com/shadowsocks/shadowsocks-android/master/core/src/main/assets/acl/$route.acl").openConnection() as HttpURLConnection
