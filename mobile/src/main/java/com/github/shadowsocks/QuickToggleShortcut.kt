        ...
        if (intent.action == Intent.ACTION_CREATE_SHORTCUT) {
            setResult(
                ...
                ShortcutManagerCompat.createShortcutResultIntent(
                    this,
                    ShortcutInfoCompat.Builder(this, "toggle").setIntent(
                        Intent(this, QuickToggleShortcut::class.java).setAction(
                            Intent.ACTION_MAIN
                        )
                    ).setIcon(
                    ...
                    ).setShortLabel(getString(R.string.quick_toggle)).build()
                )
            )
            finish()
        } else {
